...
export default function EmailTemplate(props) {
  const fallback = PREVIEW_DATA[props?.type] ?? PREVIEW_DATA.monthlyReport;
  const userName = props?.userName ?? fallback.userName ?? "";
  const type = props?.type ?? fallback.type ?? "monthly-report";
  const data = { ...(fallback.data || {}), ...(props?.data || {}) };
